...
@interface EDGPodDetailViewController ()

@end

@implementation EDGPodDetailViewController

- (void)viewDidLoad
{
    self.navBar.topItem.title = self.post.postTitle;
...
;
    ...
    [self.navBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont fontWithName:@"Avenir-Heavy" size:18], NSFontAttributeName, [UIColor whiteColor], NSForegroundColorAttributeName, nil]];
